brooklyn-social-apps
==================

Brooklyn deployment and management of Social Apps:
At the moment, we support Drupal and Wordpress
...
at http://brooklyncentral.github.com/ :
        ...
        export BROOKLYN_CLASSPATH=target/brooklyn-social-apps-0.1.0-SNAPSHOT.jar
        brooklyn launch -a io.cloudsoft.socialapps.drupal.examples.BasicDrupalApp -l aws-ec2:us-east-1
or
        brooklyn launch -a io.cloudsoft.socialapps.drupal.examples.ClusteredDrupalApp -l aws-ec2:us-east-1
or
        brooklyn launch -a io.cloudsoft.socialapps.wordpress.examples.BasicWordpressApp -l aws-ec2:us-east-1
or
        brooklyn launch -a io.cloudsoft.socialapps.wordpress.examples.ClusteredWordpressApp -l aws-ec2:us-east-1

And, of course, as it's just java, you can run it in any number of ways (such as an IDE), 
pointing at the static `main` in `io.cloudsoft.socialapps.*`.
